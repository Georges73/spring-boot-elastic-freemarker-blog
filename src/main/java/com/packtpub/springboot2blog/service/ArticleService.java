...
public class ArticleService {
    ...
    public Page<Article> search(String q, Pageable pageable) {
        return articleRepository.findByBodyContaining( q, pageable);
        
        
    }
	
	  public Page<Article> searchByBoth(String q, Pageable pageable) { return
	  articleRepository.findByTitleContainingAndBodyContaining(q, q, pageable); }
